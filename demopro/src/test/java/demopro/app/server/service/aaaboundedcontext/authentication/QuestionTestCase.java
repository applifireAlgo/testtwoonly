...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionDetails("KC3thMjbuy");
        question.setQuestion("dvm95DioZK7kv6LfnhCFO2imoa0llrncDzuaYm2UEb597eL5nH");
        question.setLevelid(6);
        question.setQuestionIcon("xSPa6MmhxtEnvaf8XnkbnCWTnfUh6K0CdOOmwbH827WVWg9qoy");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("vlbdJ9BG7D");
            question.setQuestion("uFzAuqrfYd8fvYP1qd8N3ghx0YsB0MSaU4U0ggUJWp5jkhzpFI");
            question.setVersionId(1);
            question.setLevelid(1);
            question.setQuestionIcon("LwbG3bMae16RX3COPZzkNCgsDbvtNszgmmavEOnvN8mipwVZjj");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "kCh2yDeBTZv8vXKoIa21E9ZNIikK8Awekdoi1p2TkhZYoPTH4Z7W8Tbsck5qgSy7O"));

Ext
		.define(
				'Demopro.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Demopro.view.searchengine.search.SearchEngineMainPanelController','Demopro.view.searchengine.search.PanelHeaderField' ,'Demopro.view.searchengine.search.ReportGridView','Demopro.view.searchengine.search.ReportChartView','Demopro.view.searchengine.search.documentView','Demopro.view.searchengine.search.DouMeanView','Demopro.view.googlemaps.map.MapPanel'],

Ext.define('Demopro.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Demopro.view.searchengine.search.NorthPanel', 'Demopro.view.searchengine.search.SearchResult','Demopro.view.searchengine.search.SearchEngineMainPanelController'],

 ...
 */
Ext.define('Demopro.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Demopro.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Demopro.view.fw.component.DateTimePicker(o);
    },

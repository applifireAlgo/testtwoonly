Ext.define('Demopro.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Demopro.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Demopro.view.console.ConsoleWindow');

Ext.define("Demopro.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Demopro.view.clouddrive.CloudDriveController',
	             'Demopro.view.clouddrive.documentview.DocumentsView',
	             'Demopro.view.clouddrive.drivedetails.DriveDetails',
	             //'Demopro.view.clouddrive.documentview.DocumentListView'
	             ],

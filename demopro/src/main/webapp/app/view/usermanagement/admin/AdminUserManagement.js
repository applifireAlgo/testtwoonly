Ext.define('Demopro.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Demopro.view.usermanagement.admin.UserPasswordReset',
	            'Demopro.view.usermanagement.admin.AddUserDetails',
	            'Demopro.view.usermanagement.admin.ViewUser'],

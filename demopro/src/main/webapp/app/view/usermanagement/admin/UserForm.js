Ext.define('Demopro.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Demopro.view.usermanagement.admin.AddUserDetailsViewModel', 'Demopro.model.AddUserDataModel' ],

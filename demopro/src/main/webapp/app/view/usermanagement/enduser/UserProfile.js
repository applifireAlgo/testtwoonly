Ext.define('Demopro.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Demopro.view.usermanagement.enduser.UserProfileController', 'Demopro.view.usermanagement.admin.AddUserDetailsViewModel', 'Demopro.model.AddUserDataModel' ],

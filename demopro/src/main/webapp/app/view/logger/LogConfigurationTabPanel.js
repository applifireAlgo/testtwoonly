...
Ext
		.define(
				'Demopro.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Demopro.view.logger.tabs.details.DetailsTab',
							'Demopro.view.logger.tabs.fileconnector.FileConnectorTab',
							'Demopro.view.logger.tabs.dbconnector.DBConnectorTab',
							'Demopro.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Demopro.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Demopro.view.logger.LogConfigurationTabPanelController',

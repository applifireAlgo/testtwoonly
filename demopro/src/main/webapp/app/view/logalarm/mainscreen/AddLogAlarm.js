 ...
 * 
 */
Ext.define('Demopro.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Demopro.view.logalarm.mainscreen.AddLogAlarmController',
			'Demopro.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Demopro.view.logalarm.mainscreen.AppAlarmPanel',

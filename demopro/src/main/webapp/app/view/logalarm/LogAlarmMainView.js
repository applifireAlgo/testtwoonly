 ...
 * 
 */
Ext.define('Demopro.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Demopro.view.logalarm.LogAlarmMainViewController',
			'Demopro.view.logalarm.tree.LogAlarmTreePanel',
			'Demopro.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',

 ...
 * 
 */
Ext.define('Demopro.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Demopro.view.securityconfig.SecurityConfigController',
			'Demopro.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',

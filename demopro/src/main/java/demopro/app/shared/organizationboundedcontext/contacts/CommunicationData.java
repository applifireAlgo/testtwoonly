...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            demopro.app.shared.organizationboundedcontext.contacts.CommunicationData other = (demopro.app.shared.organizationboundedcontext.contacts.CommunicationData) obj;
            if (commDataId == null) {
                return false;

...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            demopro.app.shared.organizationboundedcontext.contacts.CommunicationGroup other = (demopro.app.shared.organizationboundedcontext.contacts.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;

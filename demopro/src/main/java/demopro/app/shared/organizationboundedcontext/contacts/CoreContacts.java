package demopro.app.shared.organizationboundedcontext.contacts;
...
import demopro.app.shared.EntityAudit;
import javax.persistence.Embedded;
import demopro.app.shared.SystemInfo;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<demopro.app.shared.organizationboundedcontext.location.Address>();
        }
        if (_address != null) {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<demopro.app.shared.organizationboundedcontext.contacts.CommunicationData>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            demopro.app.shared.organizationboundedcontext.contacts.CoreContacts other = (demopro.app.shared.organizationboundedcontext.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;

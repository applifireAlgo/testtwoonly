package demopro.app.server.repository.democontext.demodomin.aspect;
...
@Aspect
@Component
public class RepositorydemodominAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* demopro.app.server.repository.democontext.demodomin..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* demopro.app.server.repository.democontext.demodomin..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* demopro.app.server.repository.democontext.demodomin..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* demopro.app.server.repository.democontext.demodomin..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* demopro.app.server.repository.democontext.demodomin..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* demopro.app.server.repository.democontext.demodomin..*(..))")

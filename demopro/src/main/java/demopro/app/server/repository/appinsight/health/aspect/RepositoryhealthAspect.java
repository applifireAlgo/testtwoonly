package demopro.app.server.repository.appinsight.health.aspect;
...
public class RepositoryhealthAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* demopro.app.server.repository.appinsight.health..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* demopro.app.server.repository.appinsight.health..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* demopro.app.server.repository.appinsight.health..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* demopro.app.server.repository.appinsight.health..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* demopro.app.server.repository.appinsight.health..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* demopro.app.server.repository.appinsight.health..*(..))")

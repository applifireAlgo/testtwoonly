package demopro.app.server.service.organizationboundedcontext.location.aspect;
import demopro.app.server.service.aspect.ServiceAspect;
...
public class ServicelocationAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.location..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.location..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.location..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.location..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.location..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.location..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")

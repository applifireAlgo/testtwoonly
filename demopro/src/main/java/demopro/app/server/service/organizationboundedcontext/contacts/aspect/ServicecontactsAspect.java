package demopro.app.server.service.organizationboundedcontext.contacts.aspect;
...
public class ServicecontactsAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.contacts..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.contacts..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.contacts..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.contacts..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.contacts..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.organizationboundedcontext.contacts..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")

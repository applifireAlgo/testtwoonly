package demopro.app.server.service.appinsight.health.aspect;
...
public class ServicehealthAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* demopro.app.server.service.appinsight.health..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.appinsight.health..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.appinsight.health..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.appinsight.health..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.appinsight.health..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.appinsight.health..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")

package demopro.app.server.service.democontext.demodomin.aspect;
...
@Aspect
@Component
public class ServicedemodominAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* demopro.app.server.service.democontext.demodomin..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.democontext.demodomin..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.democontext.demodomin..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.democontext.demodomin..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.democontext.demodomin..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* demopro.app.server.service.democontext.demodomin..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")

package demopro.app.server.businessservice.democontext.demodomin.aspect;
import demopro.app.server.businessservice.aspect.BusinessAspect;
...
@Aspect
@Component
public class BusinessServicedemodominAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* demopro.app.server.businessservice.democontext.demodomin..*(..))")

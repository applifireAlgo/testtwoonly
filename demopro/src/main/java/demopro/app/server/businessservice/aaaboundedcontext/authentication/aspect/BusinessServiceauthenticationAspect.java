package demopro.app.server.businessservice.aaaboundedcontext.authentication.aspect;
...
public class BusinessServiceauthenticationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* demopro.app.server.businessservice.aaaboundedcontext.authentication..*(..))")

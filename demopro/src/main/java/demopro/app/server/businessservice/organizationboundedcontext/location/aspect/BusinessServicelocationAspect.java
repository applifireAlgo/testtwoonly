package demopro.app.server.businessservice.organizationboundedcontext.location.aspect;
...
public class BusinessServicelocationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* demopro.app.server.businessservice.organizationboundedcontext.location..*(..))")

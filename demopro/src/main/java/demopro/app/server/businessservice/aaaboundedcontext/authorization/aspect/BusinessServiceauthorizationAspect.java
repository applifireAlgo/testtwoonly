package demopro.app.server.businessservice.aaaboundedcontext.authorization.aspect;
...
public class BusinessServiceauthorizationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* demopro.app.server.businessservice.aaaboundedcontext.authorization..*(..))")

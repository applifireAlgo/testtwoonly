package demopro.app.server.businessservice.organizationboundedcontext.contacts.aspect;
...
public class BusinessServicecontactsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* demopro.app.server.businessservice.organizationboundedcontext.contacts..*(..))")

...
public class ServicehealthAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.appinsight.health..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.appinsight.health..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")

Ext.define("Testtwo.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Testtwo.view.clouddrive.CloudDriveController',
	             'Testtwo.view.clouddrive.documentview.DocumentsView',
	             'Testtwo.view.clouddrive.drivedetails.DriveDetails',
	             //'Testtwo.view.clouddrive.documentview.DocumentListView'
	             ],

 ...
 * 
 */
Ext.define('Testtwo.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testtwo.view.logalarm.mainscreen.AddLogAlarmController',
			'Testtwo.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testtwo.view.logalarm.mainscreen.AppAlarmPanel',

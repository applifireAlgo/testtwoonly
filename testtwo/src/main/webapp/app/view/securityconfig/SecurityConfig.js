 ...
 * 
 */
Ext.define('Testtwo.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testtwo.view.securityconfig.SecurityConfigController',
			'Testtwo.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',

 ...
 * 
 */
Ext.define('Testtwo.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testtwo.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],

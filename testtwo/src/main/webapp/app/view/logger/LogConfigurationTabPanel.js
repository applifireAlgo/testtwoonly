...
Ext
		.define(
				'Testtwo.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testtwo.view.logger.tabs.details.DetailsTab',
							'Testtwo.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testtwo.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testtwo.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testtwo.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testtwo.view.logger.LogConfigurationTabPanelController',

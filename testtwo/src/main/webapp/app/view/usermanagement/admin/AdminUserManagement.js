Ext.define('Testtwo.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testtwo.view.usermanagement.admin.UserPasswordReset',
	            'Testtwo.view.usermanagement.admin.AddUserDetails',
	            'Testtwo.view.usermanagement.admin.ViewUser'],

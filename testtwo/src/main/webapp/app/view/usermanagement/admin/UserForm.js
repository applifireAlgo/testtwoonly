Ext.define('Testtwo.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testtwo.view.usermanagement.admin.AddUserDetailsViewModel', 'Testtwo.model.AddUserDataModel' ],

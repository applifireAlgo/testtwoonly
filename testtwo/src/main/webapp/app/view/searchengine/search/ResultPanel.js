Ext
		.define(
				'Testtwo.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testtwo.view.searchengine.search.SearchEngineMainPanelController','Testtwo.view.searchengine.search.PanelHeaderField' ,'Testtwo.view.searchengine.search.ReportGridView','Testtwo.view.searchengine.search.ReportChartView','Testtwo.view.searchengine.search.documentView','Testtwo.view.searchengine.search.DouMeanView','Testtwo.view.googlemaps.map.MapPanel'],

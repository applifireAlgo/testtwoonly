Ext.define('Testtwo.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testtwo.view.searchengine.search.NorthPanel', 'Testtwo.view.searchengine.search.SearchResult','Testtwo.view.searchengine.search.SearchEngineMainPanelController'],
